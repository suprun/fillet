...
RUNTIME_FILES = (
    ...
    "gui/__init__.py",
    "gui/align_feature_canvas_widget.py",
    "gui/align_feature_map_tool.py",
    "gui/array_canvas_widget.py",
    "gui/array_along_path_canvas_widget.py",
    "gui/array_along_path_map_tool.py",
    "gui/array_map_tool.py",
    "gui/boolean_feature_canvas_widget.py",
    "gui/boolean_feature_map_tool.py",
    "gui/cad_canvas_widget.py",
    ...
    "gui/extract_part_canvas_widget.py",
    "gui/extract_part_map_tool.py",
    "gui/gui_utils.py",
    "gui/map_tool.py",
    "gui/match_edge_canvas_widget.py",
    "gui/match_edge_map_tool.py",
    ...
    "resources/icons/mActionAlignFeature.svg",
    "resources/icons/mActionArrayAlongPath.svg",
    ...
    "resources/icons/mActionExtractPart.svg",
    ...
    "resources/icons/mActionMatchEdge.svg",
    ...
    "resources/mAlgorithmClip.svg",
    "resources/mAlgorithmDifference.svg",
)
TRANSLATION_LOCALES = (
